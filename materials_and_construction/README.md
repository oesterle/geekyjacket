...
Also, you'll note that we power the strip from the ~3.7V battery, rather than its 5V rated power. This is fairly common in wearable projects, and exploits the WS2812B (NeoPixel) LED strip tolerance for somewhat lower voltage.
